...
<#assign recommendedIdp = '' />
<#if isInvitedUser>
    <#assign emailDomain = invitedEmail?keep_after('@')?lower_case />
    <#if emailDomain == 'gmail.com' || emailDomain == 'googlemail.com'>
        <#assign recommendedIdp = 'google' />
    <#elseif emailDomain == 'outlook.com' || emailDomain == 'hotmail.com' || emailDomain == 'live.com' || emailDomain == 'msn.com' || emailDomain == 'outlook.fr' || emailDomain == 'hotmail.fr'>
        <#assign recommendedIdp = 'microsoft' />
    </#if>
</#if>
...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#if section = "header">
        <#if isInvitedUser>
            ${msg("loginInvitedWelcome")}
        <#else>
            ${msg("loginWelcome")}
        </#if>
    <#elseif section = "subtitle">
        <#if isInvitedUser>
            ${msg("loginInvitedSubtitle")}
        <#else>
            ${msg("loginSubtitle")}
        </#if>
    ...
    <#elseif section = "socialProviders">
        <#if realm.password && social?? && social.providers?? && (social.providers?size gt 0)>
            ...
            <#if isInvitedUser>
                <#-- Invited user: show email badge and recommended IdP prominently -->
                <div class="of-invited-email-badge">
                ...
                <#-- Show recommended IdP first if there's a match -->
                <#if recommendedIdp != ''>
                    <p class="of-invited-hint">${msg("loginInvitedRecommendedIdp")}</p>
                    <div class="of-social-section">
                        <div class="of-social-buttons">
                            <#list social.providers as p>
                                <#if p.providerId == recommendedIdp || p.alias?contains(recommendedIdp)>
                                    <a
                                        href="${p.loginUrl}"
                                        class="of-social-btn of-social-btn--${p.alias!p.providerId} of-social-btn--recommended"
                    ...
                    <div class="of-separator" role="separator">
                        <span class="of-separator-text">${msg("loginInvitedOrOtherOptions")}</span>
                    </div>

                    <#-- Other IdPs (non-recommended) -->
                    <div class="of-social-section">
                        <div class="of-social-buttons">
                            <#list social.providers as p>
                                <#if p.providerId != recommendedIdp && !p.alias?contains(recommendedIdp)>
                ...
                <#else>
                    <#-- No recommended IdP: show all providers normally -->
                    <p class="of-invited-hint">${msg("loginInvitedChooseIdp")}</p>
                    <div class="of-social-section">
                        <div class="of-social-buttons">
                            <#list social.providers as p>
                                <a
                ...
                <#-- Separator before password option -->
                <div class="of-separator" role="separator">
                    <span class="of-separator-text">${msg("or")}</span>
                </div>

            <#else>
                <#-- Standard login: show all providers normally -->
                <div class="of-social-section">
                    <div class="of-social-buttons">
                        <#list social.providers as p>
                            <a
    ...
    <#elseif section = "form">
        <#if realm.password>
            <#if isInvitedUser>
                <#-- Invited user: show password setup option -->
                <p class="of-invited-hint">${msg("loginInvitedSetupPassword")}</p>
            </#if>
                ...
                <div class="of-form-group">
                    ...
                    <div class="of-input-wrapper">
                        <input
                            ...
                            name="username"
                            type="text"
                            class="of-input<#if messagesPerField.existsError('username','password')> of-input--error</#if><#if isInvitedUser> of-input--readonly</#if>"
                            value="${(login.username!'')}"
                            autocomplete="username"
                            <#if isInvitedUser>readonly<#else>autofocus</#if>
        ...
        <#-- Registration Link (hidden for invited users who already have an account) -->
        <#if !isInvitedUser && realm.password && realm.registrationAllowed && !registrationDisabled??>

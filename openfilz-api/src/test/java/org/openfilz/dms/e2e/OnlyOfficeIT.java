 ...
 *
 * Note: End-to-end tests that require the OnlyOffice Document Server container
 * are located in {@link OnlyOfficeEnd2EndIT}.
 */
@Slf4j
@Testcontainers
...
public class OnlyOfficeIT extends TestContainersKeyCloakConfig {
    ...
    public OnlyOfficeIT(WebTestClient webTestClient, JacksonJsonEncoder customJacksonJsonEncoder) {
